# Graph Report - manajemen-gmf  (2026-08-04)

## Corpus Check
- 273 files · ~319,555 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2063 nodes · 2748 edges · 270 communities (234 shown, 36 thin omitted)
...
- **Why does `Member` connect `Member` to `Illuminate\Bus\Queueable`, `ApprovalCenterController.php`, `Illuminate\Database\Eloquent\Factories\HasFactory`, `MemberApprovedMail`, `Illuminate\Http\Request`, `ScanQrController`, `MembershipRenewal`, `RegistrationController`, `StaffInvitation`?**
